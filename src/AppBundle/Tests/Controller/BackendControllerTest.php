...
//            array('/admin/pages/page/1/edit'),
            ...
            array('/admin/pages/newsletter-users/list'),
            array('/admin/pages/newsletter-users/create'),
            array('/admin/pages/newsletter-users/1/delete'),
            array('/admin/pages/newsletter-users/1/edit'),
